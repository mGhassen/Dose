...
export function useStockMovements(params?: { page?: number; limit?: number; itemId?: string; ingredientId?: string; movementType?: string; startDate?: string; endDate?: string }) {
  return useQuery({
