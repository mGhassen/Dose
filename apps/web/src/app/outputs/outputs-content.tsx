...
export default function OutputsContent() {
  ...
  const handleBulkExport = async (entries: Entry[]) => {
    ...
    a.href = url;
    a.download = `outputs-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            All money going out - expenses, subscriptions, loan payments, and other costs
          </p>
        </div>
      </div>
