  ...
  try {
      ...
      if (producedItemData) {
        ...
        itemData = {
          ...
          category: recipeData.category
            ...
            : null,
          output_quantity: recipeData.output_quantity ?? recipeData.serving_size,
          serving_size: recipeData.output_quantity ?? recipeData.serving_size,
    ...
    if (itemData.instructions != null) {
      return NextResponse.json({
        ...
        outputQuantity: itemData.output_quantity ?? itemData.serving_size,
        servingSize: itemData.output_quantity ?? itemData.serving_size,
