...
CREATE INDEX idx_personnel_salary_projection_personnel_id ON personnel_salary_projections(personnel_id);
CREATE INDEX idx_personnel_salary_projection_month ON personnel_salary_projections(month);
CREATE INDEX idx_personnel_salary_projection_is_projected ON personnel_salary_projections(is_projected);
CREATE INDEX idx_personnel_salary_projection_is_net_paid ON personnel_salary_projections(is_net_paid);
CREATE INDEX idx_personnel_salary_projection_is_taxes_paid ON personnel_salary_projections(is_taxes_paid);
CREATE INDEX idx_personnel_salary_projection_net_payment_date ON personnel_salary_projections(net_payment_date);
CREATE INDEX idx_personnel_salary_projection_taxes_payment_date ON personnel_salary_projections(taxes_payment_date);
